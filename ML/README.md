...
| Поле | Тип | Обязательное | Описание | Пример | Советы |
|------|-----|--------------|----------|--------|--------|
...
Требуется: знание Python, опыт работы с библиотеками для ML (scikit-learn, pandas),
понимание алгоритмов рекомендательных систем.
Проект включает: сбор данных, проектирование модели, оценку качества.
