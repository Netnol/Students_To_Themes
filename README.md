...
##### Важно! В первый раз запустите с конфигурацией "SPRING_PROFILES_ACTIVE=dev", чтобы созать все таблицы и flyway миграции работали, тогда уже можно будет запускать с "prod" 
Пример:
```bash
